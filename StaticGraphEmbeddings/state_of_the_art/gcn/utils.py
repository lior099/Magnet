...
def load_data(sub_G, file_tags, num_of_nodes, features_file=None):
    ...
    if features_file is None:
        ...
        # example for features file is in datasets directory. Currently we have only Cora's features
