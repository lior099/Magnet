    ...
    for network in range(1, 2):
        ...
        for g in range(1, 4):
            graph_filenames.append(
                os.path.join("..", "PathwayProbabilitiesCalculation", "data", f"toy_network_{network}", f"toy_network_{network}" + f"_graph_{g}_01.csv"))
            graph_filenames.append(
                os.path.join("..", "PathwayProbabilitiesCalculation", "data", f"toy_network_{network}", f"toy_network_{network}" + f"_graph_{g}_10.csv"))
